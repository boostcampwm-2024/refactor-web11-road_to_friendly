...
const ContentSharePhaseView = () => {
  ...
  return (
    <section
      css={ContentSharePhaseViewStyle}
      style={{ padding: currentContent === null ? '4.5rem 3.75rem' : '1.5rem' }}
    >
      {currentContent === null ? (
        <WaitingListEmpty />
      ) : (
...
export default ContentSharePhaseView;

const ContentSharePhaseViewStyle = css([
  {
    position: 'relative',
    width: '40rem',
    height: '28.5625rem',
